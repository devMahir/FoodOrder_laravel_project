            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                        <div class="row">
                             <form class="contact-form" method="POST" action="{{ route('message.store') }}">
                                @csrf
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2021 <a href="#">Mamma's Kitchen.</a> <br>  Developed by <a href="https://github.com/devMahir"  target="_blank">Mahir Shahriar</a>
                            </p>
                        </div>
                    </div>
                </div>
